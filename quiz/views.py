...
def displaypdfmccp(request):
    path=(r"C:\Users\Tejaswi\Desktop\Poll-App (1) (1)\Poll-App (1)\quiz\static\upload\MCCP")
    pdf_list =os.listdir(path)   
    return render(request, 'quiz/MCCP_notes.html', {'pdfs': pdf_list})

def displaypdfdm(request):
    path=(r"C:\Users\Tejaswi\Desktop\Poll-App (1) (1)\Poll-App (1)\quiz\static\upload\DM")
    pdf_list =os.listdir(path)   
    return render(request, 'quiz/DM_notes.html', {'pdfs': pdf_list})

def displaypdfos(request):
    path=(r"C:\Users\Tejaswi\Desktop\Poll-App (1) (1)\Poll-App (1)\quiz\static\upload\OS")
    pdf_list =os.listdir(path)   
    return render(request, 'quiz/OS_notes.html', {'pdfs': pdf_list})

def displaypdfwt(request):
    path=(r"C:\Users\Tejaswi\Desktop\Poll-App (1) (1)\Poll-App (1)\quiz\static\upload\WT")
    pdf_list =os.listdir(path)   
    return render(request, 'quiz/WT_notes.html', {'pdfs': pdf_list})

def displaypdfai(request):
    path=(r"C:\Users\Tejaswi\Desktop\Poll-App (1) (1)\Poll-App (1)\quiz\static\upload\AI")
    pdf_list =os.listdir(path)   
